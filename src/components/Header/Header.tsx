...
import TigerIcon from 'assets/images/tigerswap/tigerIcon.svg';
import TigerLogo from 'assets/images/tigerswap/tigerLogo.png';
...
const Header: React.FC = () => {
  ...
  return (
    <Box className='header'>
      ...
      <Link to='/'>
        <img
          src={mobileWindowSize ? TigerIcon : TigerLogo}
          alt='TigerLogo'
          height={60}
        />
      </Link>
